...
//		insertCor45AdapterRules();
	...
	private void insertFieldMappers() {                                                                                                                                                 
	...
	public void insertPOS34AdapterRules() {                                                                                                                                             
...
//	public void insertPOS45AdapterRules() {                                                                                                                                             
...
//                                                                                                                                                                                        
//	}                                                                                                                                                                                   
	public void insertATM34AdapterRules() {                                                                                                                                             
		int id = EnviromentType.ATM34.getId();
		daoRule.insertOrUpdate(new Rule(id,ADAPTER,"00", "mli", CONTAINS, "VISA", MLI_VISA_EXCLUSIVE.getId()));
		daoRule.insertOrUpdate(new Rule(id,ADAPTER,"01", "mli", CONTAINS, "EXCLUSIVE", MLI_EXCLISIVE.getId()));
		daoRule.insertOrUpdate(new Rule(id,ADAPTER,"02", "mli", CONTAINS, "", MLI_INCLUSIVE.getId()));
	}                                                                                                                                                                                   
//	public void insertATM45AdapterRules() {                                                                                                                                             
//		int id = EnviromentType.ATM45.getId();
//		daoRule.insertOrUpdate(new Rule(id,ADAPTER,"00", "mli", CONTAINS, "VISA", MLI_VISA_EXCLUSIVE.getId()));
//		daoRule.insertOrUpdate(new Rule(id,ADAPTER,"01", "mli", CONTAINS, "EXCLUSIVE", MLI_EXCLISIVE.getId()));
//		daoRule.insertOrUpdate(new Rule(id,ADAPTER,"02", "mli", CONTAINS, "", MLI_INCLUSIVE.getId()));
//	}                                                                                                                                                                                   
	public void insertCEL34AdapterRules() {                                                                                                                                             
		int id = EnviromentType.CEL34.getId();
		daoRule.insertOrUpdate(new Rule(id,ADAPTER,"00", "mli", CONTAINS, "VISA", MLI_VISA_EXCLUSIVE.getId()));
		daoRule.insertOrUpdate(new Rule(id,ADAPTER,"01", "mli", CONTAINS, "EXCLUSIVE", MLI_EXCLISIVE.getId()));
		daoRule.insertOrUpdate(new Rule(id,ADAPTER,"02", "mli", CONTAINS, "", MLI_INCLUSIVE.getId()));
	}                                                                                                                                                                                   
//	public void insertCEL45AdapterRules() {                                                                                                                                             
//		int id = EnviromentType.CEL45.getId();
//		daoRule.insertOrUpdate(new Rule(id,ADAPTER,"00", "mli", CONTAINS, "VISA", MLI_VISA_EXCLUSIVE.getId()));
//		daoRule.insertOrUpdate(new Rule(id,ADAPTER,"01", "mli", CONTAINS, "EXCLUSIVE", MLI_EXCLISIVE.getId()));
//		daoRule.insertOrUpdate(new Rule(id,ADAPTER,"02", "mli", CONTAINS, "", MLI_INCLUSIVE.getId()));
//	}                                                                                                                                                                                   
	public void insertCor34AdapterRules() {                                                                                                                                             
		int id = EnviromentType.COR34.getId();
		daoRule.insertOrUpdate(new Rule(id,ADAPTER,"00", "mli", CONTAINS, "VISA", MLI_VISA_EXCLUSIVE.getId()));
		daoRule.insertOrUpdate(new Rule(id,ADAPTER,"01", "mli", CONTAINS, "EXCLUSIVE", MLI_EXCLISIVE.getId()));
		daoRule.insertOrUpdate(new Rule(id,ADAPTER,"02", "mli", CONTAINS, "", MLI_INCLUSIVE.getId()));
	}                                                                                                                                                                                   
//	public void insertCor45AdapterRules() {                                                                                                                                             
...
//	}                                                                                                                                                                                   
	...
	public void insertPOS34ParserRules() {                                                                                                                                              
	...
	public void insertATM34ParserRules() {                                                                                                                                              
	...
	public void insertCEL34ParserRules() {                                                                                                                                              
	...
	public void insertCOR34ParserRules() {                                                                                                                                              
	...
	public void insertPOS34SimulatorRules() {                                                                                                                                           
		int POS34 = EnviromentType.POS34.getId();
	...
	public void insertATM34SimulatorRules() {                                                                                                                                           
		int ATM34 = EnviromentType.ATM34.getId();
	...
	public void insertCEL34SimulatorRules() {                                                                                                                                           
	...
	public void insertCOR34SimulatorRules() {                                                                                                                                           
		int COR34 = EnviromentType.COR34.getId();
