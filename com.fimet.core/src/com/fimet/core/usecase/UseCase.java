...
public final class UseCase implements Cloneable, Serializable, IUseCase {
	...
	public boolean hasMsgAcqReq() {
		return acquirer != null && acquirer.getRequest() != null && acquirer.getRequest().getMessage() != null; 
	}
	public Message getMsgAcqReq() {
		return hasMsgAcqReq() ? acquirer.getRequest().getMessage() : null;
	}
	public boolean hasMsgAcqRep() {
		return acquirer != null && acquirer.getResponse() != null && acquirer.getResponse().getMessage() != null; 
	}
	public Message getMsgAcqRep() {
		return hasMsgAcqRep() ? acquirer.getResponse().getMessage() : null;
	}
	public boolean hasMsgIssReq() {
		return issuer != null && issuer.getRequest() != null && issuer.getRequest().getMessage() != null; 
	}
	public Message getMsgIssReq() {
		return hasMsgIssReq() ? issuer.getRequest().getMessage() : null;
	}
	public boolean hasMsgIssRep() {
		return issuer != null && issuer.getResponse() != null && issuer.getResponse().getMessage() != null; 
	}
	public Message getMsgIssRep() {
		return hasMsgIssRep() ? issuer.getResponse().getMessage() : null;
	}
