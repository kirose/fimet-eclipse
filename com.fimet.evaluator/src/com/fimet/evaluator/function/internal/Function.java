...
public abstract class Function implements Expression {
	...
	public static void init(){
		functions.put("MIN", com.fimet.evaluator.function.internal.impl.MIN.class);
		functions.put("MAX", com.fimet.evaluator.function.internal.impl.MAX.class);
		functions.put("value", com.fimet.evaluator.function.internal.impl.FValue.class);
		functions.put("exists", com.fimet.evaluator.function.internal.impl.FExists.class);
		functions.put("length", com.fimet.evaluator.function.internal.impl.FLength.class);
		functions.put("substring", com.fimet.evaluator.function.internal.impl.FSubstring.class);
		functions.put("contains", com.fimet.evaluator.function.internal.impl.FContains.class);
		functions.put("matches", com.fimet.evaluator.function.internal.impl.FMatches.class);
		functions.put("indexOf", com.fimet.evaluator.function.internal.impl.FIndexOf.class);
		functions.put("isNumeric", com.fimet.evaluator.function.internal.impl.FIsNumeric.class);
		functions.put("isAlphabetic", com.fimet.evaluator.function.internal.impl.FIsAlphabetic.class);
		functions.put("isHexadecimal", com.fimet.evaluator.function.internal.impl.FIsHexadecimal.class);
		functions.put("in", com.fimet.evaluator.function.internal.impl.FIn.class);
	}
