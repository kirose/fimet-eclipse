...
import com.atenea.evaluator.function.ADD_NUMERIC;
import com.atenea.evaluator.function.DIV;
import com.atenea.evaluator.function.FACTORIAL;
import com.atenea.evaluator.function.MOD;
import com.atenea.evaluator.function.MUL;
import com.atenea.evaluator.function.POW;
import com.atenea.evaluator.function.SUB;
import com.atenea.evaluator.function.TERNARY_NUMERIC;
import com.atenea.evaluator.function.TERNARY_TYPE;
import com.atenea.evaluator.stmt.ASSIGNATION;
import com.atenea.evaluator.stmt.BLOCK;
import com.atenea.evaluator.stmt.FOR;
import com.atenea.evaluator.stmt.GROUP;
import com.atenea.evaluator.stmt.IF;
import com.atenea.evaluator.stmt.Statement;
import com.atenea.evaluator.stmt.WHILE;
...
import com.atenea.evaluator.type.DOUBLE;
import com.atenea.evaluator.type.GROUP_NUMERIC;
import com.atenea.evaluator.type.INTEGER;
import com.atenea.evaluator.type.STRING;
