...
import com.fimet.editor.json.core.preferences.JsonPreferences;
import com.fimet.editor.json.outline.JsonContentOutlinePage;
 ...
 *
 */
public class JsonTextEditor extends TextEditor {//implements IFormPage {//, IGotoMarker, ISelectionChangedListener, IOutlineContentCreator, IOutlineSelectionHandler{

	public static final String ID = "com.fimet.editor.json.core.editors.UseCaseEditor";
    /**
     * The action ID to trigger re-formatting the selected code
     */
    static final String FORMAT_ACTION_ID = "com.fimet.usecase.format"; //$NON-NLS-1$

    /**
     * The action ID to open the Quick Outline View
     */
    static final String QUICK_OUTLINE_ACTION_ID = "com.fimet.usecase.quickOutline"; //$NON-NLS-1$

    /**
     * The editor context ID wrt. to the key binding scope
     */
    public static final String EDITOR_CONTEXT_ID = "com.fimet.context.jsonEditorScope"; //$NON-NLS-1$

    /**
     * The marker ID for JSON (e.g. warnings, compile errors)
     */
    static final String MARKER_ID = "com.fimet.usecase.validation.marker";
    ...
    public JsonTextEditor(String title) {
    	this();
	}
    public JsonTextEditor() {
    	super();
    	this.rangeHighlighter = new RangeHighlighter(this);
	}
	@Override
    ...
    public void createPartControl(Composite parent) {
        ...
        //System.out.println("JsonTextEditor.createPartControl(Composite parent) " + (viewer.getDocument() != null ? viewer.getDocument().getClass().getName() : "NoClass"));
    ...
    protected void initializeEditor() {
        ...
        IPreferenceStore myStore = Activator.getInstance().getPreferenceStore();
    ...
    public void updateSyntaxTree(JsonContext jsonContext, Map<ParseTree, ParseTree> oldToNew, Map<ParseTree, Position> positions) {
