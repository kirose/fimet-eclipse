...
import com.fimet.editor.json.model.JsonReconcilingStrategy;
import com.fimet.editor.json.outline.quickoutline.QuickOutlinePopup;
import com.fimet.editor.json.preferences.JsonTokenStyler;
import com.fimet.editor.json.preferences.format.JsonContentFormatter;
...
public class JsonSourceViewerConfiguration extends TextSourceViewerConfiguration {
    ...
    public IInformationPresenter getOutlinePresenter(final ISourceViewer sourceViewer) {
        ...
        //System.out.println("JsonSourceViewerConfiguration.getOutlinePresenter(final ISourceViewer sourceViewer) "+(sourceViewer.getDocument() != null ? sourceViewer.getDocument().getClass().getName() : "NoClass")+"-"+(sourceViewer.getDocument() != null ? sourceViewer.getDocument().get() : null));
