 ...
 *******************************************************************************/
package com.fimet.editor.json.core.preferences;

import static com.fimet.editor.json.core.preferences.JsonPreferences.AUTO_FORMAT_ON_SAVE;
import static com.fimet.editor.json.core.preferences.JsonPreferences.EDITOR_MATCHING_BRACKETS;
import static com.fimet.editor.json.core.preferences.JsonPreferences.EDITOR_MATCHING_BRACKETS_COLOR;
import static com.fimet.editor.json.core.preferences.JsonPreferences.EDITOR_TRAILING_NEWLINE;
...
//        IEclipsePreferences node = DefaultScope.INSTANCE.getNode(JsonPreferencesPlugin.PLUGIN_ID);
        IPreferenceStore node = Activator.getInstance().getPreferenceStore();
        ...
        // See com.fimet.editor.json.preferences.format.JsonFormatter.Affix for valid values
