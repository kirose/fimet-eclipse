...
public class JsonSourceViewer extends ProjectionViewer {
    ...
    public void configure(SourceViewerConfiguration configuration) {
        ...
        ((org.eclipse.text.undo.DocumentUndoManager)getUndoManager()).addDocumentUndoListener(new IDocumentUndoListener() {
			@Override
			public void documentUndoNotification(DocumentUndoEvent event) {
				if (event.getEventType() == org.eclipse.core.commands.operations.OperationHistoryEvent.UNDONE) {
					System.out.println("UNDONE"+editor);
				} else if (event.getEventType() == org.eclipse.core.commands.operations.OperationHistoryEvent.REDONE) {
					System.out.println("REDONE"+editor);
				}
			}
		});*/
    }
