...
import com.fimet.core.usecase.AbstractValidator;
 ...
 */
public class NewValidatorClassWizardPage extends NewTypeWizardPage {

	private final static String PAGE_NAME= "NewClassValidatorWizardPage"; //$NON-NLS-1$
...
//	private final static String SETTINGS_CREATEMAIN= "create_main"; // not stored any more, see https://bugs.eclipse.org/388342
	 ...
	 */
	public NewValidatorClassWizardPage() {
		super(true, PAGE_NAME);

		setTitle("Java Class Validator");
		setDescription("Create a new Java class Validator.");
	...
	private void validatorConfiguration() {
		...
		this.setSuperClass(AbstractValidator.class.getName(), false);
		//this.set
		//getPackageFragment()ackageText().set
	}
