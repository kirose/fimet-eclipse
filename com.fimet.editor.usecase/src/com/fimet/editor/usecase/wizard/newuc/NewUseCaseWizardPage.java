...
public class NewUseCaseWizardPage extends WizardPage implements Listener {
        ...
        cboAcquirer.getCombo().addSelectionListener(new SelectionAdapter() {
        	public void widgetSelected(SelectionEvent e) {
        		if (cboAcquirer.getStructuredSelection() != null) {
        			cboAcquirer.valid();
        			ISocket acquirer = (ISocket)cboAcquirer.getStructuredSelection().getFirstElement();
        ...
        cboIssuer.getCombo().addSelectionListener(new SelectionAdapter() {
        	public void widgetSelected(SelectionEvent e) {
        		if (cboIssuer.getStructuredSelection() != null) {
        			...
        			useCase.getIssuer().setConnection((ISocket)cboIssuer.getStructuredSelection().getFirstElement());
        		}
        	}
        });
	...
	public boolean isPageComplete() {
		return (resourceGroup.isValid() && cboAcquirer.isValid());
	}
	@Override
	...
	protected InputStream getInitialContents() {
		...
		//if (useCase.getAcquirer().getRequest().getMessage().getFields().isEmpty()) {
			//ISourceConnection iap = (ISourceConnection)cboAcquirer.getStructuredSelection().getFirstElement();
			//if (iap != null) {
