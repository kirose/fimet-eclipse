 ...
 *
 */
public class FieldFormatTableViewer extends TableViewer {

	private List<FieldFormat> fieldFormats;

	public FieldFormatTableViewer(Composite parent, int style) {
		super(parent, style);
		createTable();
        ...
        col.setLabelProvider(new ColumnLabelProvider() {
            ...
            public String getText(Object element) {
            	if (element instanceof FieldFormat) {
            		...
            		return ff.getIdField() != null ? ff.getIdField().substring(ff.getIdField().indexOf('.')+1,ff.getIdField().length()) : "";
            	}
	...
	public void select(FieldFormat fieldFormat) {
