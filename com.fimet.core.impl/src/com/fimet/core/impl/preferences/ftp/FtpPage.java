package com.fimet.core.impl.preferences.ftp;
...
public class FtpPage extends PreferencePage implements IWorkbenchPreferencePage {
	public static final String ID = "com.fimet.preferences.FtpPage";
	FtpPanel panel;
	Button btnApply;
    public FtpPage() {
    ...
    protected final Control createContents(Composite container) {
        ...
        panel = new FtpPanel(composite, SWT.NONE, false);
